%----Название (путь, если находится в иной директории) файла входных значений----
file_input = 'input.txt';

%----Название (путь, если нужно вывести в иную директории) файла выходных значений----
...
%----Нахождение всевозможных линейных комбинаций----
columns = length(B(1, :));
D = sum(mod(C*B, 2), 2);
